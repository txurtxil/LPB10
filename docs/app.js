...
(function () {
  ...
  const I18N = {
    es: {
      ...
      "inst.s3.cert": "🔐 Certificados: markoceri/leapmotor-certs — gracias a su autor por el material",
    ...
    en: {
      ...
      "inst.label": "04 — INSTALLATION", "inst.title": "Tester in 3 steps.",
      "inst.lead": "If someone sent you the link, this is all you need. One minute, no approval.",
      "inst.s1.t": "Join the testers group",
      "inst.s1.d": "One click, no approval. The group doubles as the channel for questions, bugs and feedback.",
      "inst.s1.cta": "groups.google.com/g/lmb10-testers",
      "inst.s2.t": "Enable the test on Google Play",
      "inst.s2.d": "With the same Google account, tap “Become a tester”.",
      "inst.s2.cta": "play.google.com · Become a tester",
      "inst.s3.t": "Install & import your certificate",
      "inst.s3.d": "Install LMB10 from Play (it can take a few minutes to appear) and follow Settings → Import certificate: Leapmotor's cloud requires mTLS with your own certificate.",
      "inst.s3.cert": "🔐 Certificates: markoceri/leapmotor-certs — thanks to its author for the material",
